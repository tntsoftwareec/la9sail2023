var app = {
    ...
    ajax: {
      ...
      clearOption: "",
      clearElement:
        ".jvectormap-label, .jvector-label, .AutoFill_border ,#gritter-notice-wrapper, .ui-autocomplete, .colorpicker, .FixedHeader_Header, .FixedHeader_Cloned .lightboxOverlay, .lightbox, .introjs-hints, .nvtooltip, .sp-container, .dz-hidden-input, .lightboxOverlay",
    ...
    layout: {
      sidebarLight: { class: "app-with-light-sidebar" },
  ...
  handleScrollbar = function () {
    "use strict";
    for (
      var a = document.querySelectorAll("[" + app.scrollBar.attr + "]"), e = 0;
      e < a.length;
      e++
    )
      generateScrollbar(a[e]);
  },
  generateScrollbar = function (a) {
    "use strict";
    if (
      !(
        $(a).attr(app.scrollBar.initAttr) ||
        (app.isMobile && $(a).attr(app.scrollBar.skipMobileAttr))
      )
    ) {
      var e = $(a).attr(app.scrollBar.heightAttr)
        ? $(a).attr(app.scrollBar.heightAttr)
        : $(a).height();
      if (($(a).css("height", e), app.isMobile))
        $(a).css("overflow-x", "scroll");
      else {
        var s =
          !!$(a).attr(app.scrollBar.wheelPropagationAttr) &&
          $(a).attr(app.scrollBar.wheelPropagationAttr);
        0 !==
        $(a).closest(
          "." + app.sidebar.class + ":not(." + app.sidebarEnd.class + ")"
        ).length
          ? (app.sidebar.scrollBar.dom = new PerfectScrollbar(a, {
              wheelPropagation: s,
            }))
          : new PerfectScrollbar(a, { wheelPropagation: s });
      }
  ...
  handleSidebarMenu = function () {
    "use strict";
    var a = $(app.sidebar.id).attr(app.sidebar.menu.disableAnimationAttr)
        ? 0
        : app.sidebar.menu.animationTime,
      e = $(app.sidebar.id).attr(app.sidebar.menu.disableAutoCollapseAttr)
        ? 1
        : 0;
    $(document).on(
      "click",
      ...
      function () {
        ...
        0 === $("." + app.sidebar.minify.toggledClass).length &&
          (e ||
            ($(t)
              .closest("." + app.sidebar.menu.itemClass)
              .addClass(app.sidebar.menu.closingClass),
            $(t).slideUp(a, function () {
              $(t)
                .closest("." + app.sidebar.menu.itemClass)
                .addClass(app.sidebar.menu.closedClass)
                .removeClass(
                  app.sidebar.menu.expandClass +
                    " " +
                    app.sidebar.menu.closingClass
                );
            })),
          $(s).is(":visible")
            ? $(s)
                .closest("." + app.sidebar.menu.itemClass)
                .addClass(app.sidebar.menu.closingClass)
                .removeClass(app.sidebar.menu.expandClass)
            : $(s)
                .closest("." + app.sidebar.menu.itemClass)
                .addClass(app.sidebar.menu.expandingClass)
                .removeClass(app.sidebar.menu.closedClass),
          $(s).slideToggle(a, function () {
            var a = $(this).closest("." + app.sidebar.menu.itemClass);
            $(s).is(":visible")
              ? ($(a).addClass(app.sidebar.menu.expandClass),
                $(a).removeClass(app.sidebar.menu.closedClass))
              : ($(a).addClass(app.sidebar.menu.closedClass),
                $(a).removeClass(app.sidebar.menu.expandClass)),
              $(a).removeClass(
  ...
  handleSidebarToggle = function () {
    ...
    $(document).on(
      ...
      function (a) {
        a.preventDefault(),
          $(app.id)
            .addClass(app.sidebar.mobile.toggledClass)
            .removeClass(app.sidebar.mobile.closedClass);
      }
    ),
      $(document).on(
        "click",
        ...
        function (a) {
          a.preventDefault(),
            $(app.id)
              .removeClass(app.sidebar.mobile.toggledClass)
              .addClass(app.sidebar.mobile.closedClass),
            setTimeout(function () {
  ...
  handleSidebarEndToggle = function () {
    ...
    $(document).on(
      "click",
      "[" + app.sidebarEnd.toggleAttr + "]",
      function (a) {
        a.preventDefault(),
          $(app.id).hasClass(app.sidebarEnd.toggledClass) ||
          $(app.id).hasClass(app.sidebarEnd.collapsedClass)
            ? $(app.id).hasClass(app.sidebarEnd.toggledClass)
              ? $(app.id)
                  .removeClass(app.sidebarEnd.toggledClass)
                  .addClass(app.sidebarEnd.collapsedClass)
              : $(app.id)
                  .removeClass(app.sidebarEnd.collapsedClass)
                  .addClass(app.sidebarEnd.toggledClass)
      ...
      $(document).on(
        ...
        function (a) {
          a.preventDefault(),
            $(app.id)
              .addClass(app.sidebarEnd.mobile.toggledClass)
              .removeClass(app.sidebarEnd.mobile.closedClass);
        }
      ),
      $(document).on(
        "click",
        ...
        function (a) {
          a.preventDefault(),
            $(app.id)
              .removeClass(app.sidebarEnd.mobile.toggledClass)
              .addClass(app.sidebarEnd.mobile.closedClass),
            setTimeout(function () {
  ...
  handleSidebarMinify = function () {
    ...
    ($(document).on(
      ...
      function (a) {
        ...
        if ($(app.id).hasClass(app.sidebar.minify.toggledClass))
          ...
          if (
            ($(app.id).addClass(app.sidebar.minify.toggledClass), app.isMobile)
          ) {
    ...
    Cookies) &&
      "true" == Cookies.get(app.sidebar.minify.cookieName) &&
  ...
  handlePageLoader = function () {
    ...
    $(window).on("load", function () {
      ...
      $(a).addClass(app.loader.fadingClass),
        setTimeout(function () {
          $(a)
            .removeClass(app.loader.fadingClass)
            .addClass(app.loader.loadedClass);
  ...
  handlePanelAction = function () {
    ...
    $(document).on(
      "mouseover",
      "[" + app.panel.toggle.remove.attr + "]",
      function (a) {
        $(this).attr("data-tooltip-init") ||
          (new bootstrap.Tooltip(this, {
            title: app.panel.toggle.remove.tooltipText,
            placement: "bottom",
          }).show(),
          $(this).attr("data-tooltip-init", !0));
      }
    ),
      $(document).on(
        "click",
        ...
        function (e) {
          e.preventDefault(),
            a && a.hide(),
            $(this)
              .closest("." + app.panel.class)
              .remove();
        }
      ),
      $(document).on(
        "mouseover",
        "[" + app.panel.toggle.collapse.attr + "]",
        function (e) {
          $(this).attr("data-tooltip-init") ||
            ((a = new bootstrap.Tooltip(this, {
      ...
      $(document).on(
        ...
        function (e) {
          e.preventDefault(),
            ...
            $(this)
              .closest("." + app.panel.class)
              .find("." + app.panel.bodyClass)
              .slideToggle();
        }
      ),
      $(document).on(
        "mouseover",
        "[" + app.panel.toggle.reload.attr + "]",
        function (e) {
          $(this).attr("data-tooltip-init") ||
            ((a = new bootstrap.Tooltip(this, {
        ...
        function (e) {
          ...
          if (!$(s).hasClass(app.panel.loadingClass)) {
            var t = $(s).find("." + app.panel.bodyClass),
              p =
                '<div class="' +
                app.panel.loader.class +
                '">' +
                app.panel.loader.html +
                "</div>";
            $(s).addClass(app.panel.loadingClass),
              $(t).prepend(p),
              setTimeout(function () {
                $(s).removeClass(app.panel.loadingClass),
                  $(s)
                    .find("." + app.panel.loader.class)
                    .remove();
              }, 2e3);
          }
        }
      ...
      $(document).on(
        ...
        function (e) {
          ...
          $("body").hasClass(app.panel.expandClass) &&
          $(s).hasClass(app.panel.expandClass)
            ? ($("body, ." + app.panel.class).removeClass(
            ...
            : ($("body").addClass(app.panel.expandClass),
              $(this)
                .closest("." + app.panel.class)
                .addClass(app.panel.expandClass));
        }
      );
  },
  ...
  handelTooltipPopoverActivation = function () {
    "use strict";
    if (0 !== $("[" + app.bootstrap.tooltip.attr + "]").length)
      [].slice
        .call(document.querySelectorAll("[" + app.bootstrap.tooltip.attr + "]"))
        .map(function (a) {
          return new bootstrap.Tooltip(a);
        });
    if (0 !== $("[" + app.bootstrap.popover.attr + "]").length)
      [].slice
  ...
  handleScrollToTopButton = function () {
    ...
    $(document).scroll(function () {
      $(document).scrollTop() >= app.scrollToTopBtn.heightShow
        ? $("[" + app.scrollToTopBtn.toggleAttr + "]").hasClass(
            app.scrollToTopBtn.showClass
          ) ||
          $("[" + app.scrollToTopBtn.toggleAttr + "]").addClass(
            app.scrollToTopBtn.showClass
          )
        : $("[" + app.scrollToTopBtn.toggleAttr + "]").removeClass(
            app.scrollToTopBtn.showClass
          );
    }),
  ...
  handleThemePanel = function () {
    ...
    ($(document).on(
      ...
      function () {
        var a = "." + app.themePanel.class,
          e = !1;
        $(a).hasClass(app.themePanel.activeClass)
          ? $(a).removeClass(app.themePanel.activeClass)
          : ($(a).addClass(app.themePanel.activeClass), (e = !0)),
          Cookies && Cookies.set(app.themePanel.cookieName, e);
      }
    ),
    Cookies) &&
      "true" == Cookies.get(app.themePanel.cookieName) &&
    ...
    $(document).on(
      ...
      function () {
        for (
          var a = $(this).attr(app.themePanel.theme.classAttr), e = 0;
          e < document.body.classList.length;
          e++
        ) {
          var s = document.body.classList[e];
          s.search("theme-") > -1 && $("body").removeClass(s);
        }
        $("body").addClass(a),
          $(
            "." +
            ...
            .removeClass(app.themePanel.theme.activeClass),
          $(this)
            .closest("." + app.themePanel.themeListItemCLass)
            .addClass(app.themePanel.theme.activeClass),
          Cookies &&
            (Cookies.set(app.themePanel.theme.cookieName, a),
      ...
      $(document).on(
        ...
        function () {
          var a = "";
          $(this).is(":checked")
            ? ($("." + app.header.class).addClass(
                app.themePanel.themeHeader.class
              ),
              (a = app.themePanel.themeHeader.class))
            : $("." + app.header.class).removeClass(
                app.themePanel.themeHeader.class
              ),
            Cookies && Cookies.set(app.themePanel.themeHeader.cookieName, a);
        }
      ),
      $(document).on(
        "change",
        ...
        function () {
          ...
          $(this).is(":checked")
            ? ($(app.id).addClass(app.themePanel.themeHeaderFixed.class),
              (a = app.themePanel.themeHeaderFixed.class))
            : ($("[" + app.themePanel.themeSidebarFixed.toggleAttr + "]").is(
                ":checked"
              ) &&
                !app.isMobile &&
                (alert(app.themePanel.themeHeaderFixed.errorMessage),
                $("[" + app.themePanel.themeSidebarFixed.toggleAttr + "]").prop(
                  "checked",
                  !1
                ),
                $(
              ...
              (a = app.themePanel.themeHeaderFixed.disabledClass)),
            Cookies &&
              Cookies.set(app.themePanel.themeHeaderFixed.cookieName, a);
        }
      ),
      $(document).on(
        "change",
        ...
        function () {
          var a = "";
          $(this).is(":checked")
            ? ($(app.sidebar.id).addClass(
                app.themePanel.themeSidebarGrid.class
              ),
              (a = app.themePanel.themeSidebarGrid.class))
            : $(app.sidebar.id).removeClass(
                app.themePanel.themeSidebarGrid.class
              ),
            Cookies &&
              Cookies.set(app.themePanel.themeSidebarGrid.cookieName, a);
        }
      ),
      $(document).on(
        "change",
          ...
          app.isMobile
            ...
            : ($(this).is(":checked")
                ? ($(
                    ...
                    $(app.themePanel.themeHeaderFixed.toggleAttr).prop(
                      "checked",
                      !0
                    ),
                    $(app.themePanel.themeHeaderFixed.toggleAttr).trigger(
                      "change"
                    ),
                    $(app.id).addClass(app.themePanel.themeHeaderFixed.class)),
                  $(app.id).addClass(app.themePanel.themeSidebarFixed.class),
                  generateScrollbar(document.querySelector(e)),
                  (a = app.themePanel.themeSidebarFixed.class))
                : ($(app.id).removeClass(
                    app.themePanel.themeSidebarFixed.class
                  ),
                  app.sidebar.scrollBar.dom.destroy(),
                  (app.sidebar.scrollBar.dom = ""),
                  (a = app.themePanel.themeSidebarFixed.disabledClass),
                  $(e).removeAttr(app.scrollBar.initAttr)),
              Cookies &&
                Cookies.set(app.themePanel.themeSidebarFixed.cookieName, a));
        }
      ),
      $(document).on(
        "change",
        ...
        function () {
          ...
          $(this).is(":checked")
            ? ($(app.id).addClass(app.themePanel.themeGradientEnabled.class),
              (a = app.themePanel.themeGradientEnabled.class))
            : $(app.id).removeClass(app.themePanel.themeGradientEnabled.class),
            Cookies &&
              Cookies.set(app.themePanel.themeGradientEnabled.cookieName, a);
        }
      ),
      $(document).on(
        "change",
        ...
        function () {
          ...
          $(this).is(":checked")
            ? ($("html").addClass(app.themePanel.themeDarkMode.class),
              (a = app.themePanel.themeDarkMode.class))
            : $("html").removeClass(app.themePanel.themeDarkMode.class),
            Cookies &&
              (App.initVariable(),
              Cookies.set(app.themePanel.themeDarkMode.cookieName, a),
              $(document).trigger("theme-change"));
        }
      ),
      Cookies &&
        ...
        Cookies.get(app.themePanel.themeHeader.cookieName) &&
          $(
            "." +
              app.themePanel.class +
              " [" +
            ...
            .prop("checked", !0)
            .trigger("change"),
        Cookies.get(app.themePanel.themeSidebarGrid.cookieName) &&
          $(
            "." +
              app.themePanel.class +
              " [" +
            ...
            .prop("checked", !0)
            .trigger("change"),
        Cookies.get(app.themePanel.themeGradientEnabled.cookieName) &&
          $(
            "." +
              app.themePanel.class +
              " [" +
            ...
            .prop("checked", !0)
            .trigger("change"),
        Cookies.get(app.themePanel.themeSidebarFixed.cookieName) &&
          Cookies.get(app.themePanel.themeSidebarFixed.cookieName) ==
            app.themePanel.themeSidebarFixed.disabledClass &&
          $(
            "." +
              app.themePanel.class +
              " [" +
            ...
            .prop("checked", !1)
            .trigger("change"),
        Cookies.get(app.themePanel.themeHeaderFixed.cookieName) &&
          Cookies.get(app.themePanel.themeHeaderFixed.cookieName) ==
            app.themePanel.themeHeaderFixed.disabledClass &&
          $(
            "." +
              app.themePanel.class +
              " [" +
            ...
            .prop("checked", !1)
            .trigger("change"),
        Cookies.get(app.themePanel.themeDarkMode.cookieName) &&
          $(
            "." +
              app.themePanel.class +
              " [" +
    ...
    $(document).on(
      ...
      function (a) {
        ...
        var e =
          ...
          '><i class="fa fa-check me-1"></i> Yes</a>            </div>        </div>    </div></div>';
        $("body").append(e),
          $(
      ...
      $(document).on(
        app.bootstrap.modal.event.hidden,
        '[data-modal-id="' + app.panel.localStorage.reset.modal.id + '"]',
        function (a) {
          $(
            '[data-modal-id="' + app.panel.localStorage.reset.modal.id + '"]'
  ...
  handleUnlimitedTabsRender = function () {
    function a(a, e) {
      var s = $(a).closest("." + app.unlimitedTabs.class),
        ...
        p = parseInt(
          $(s)
            .find("." + app.bootstrap.nav.tabs.class)
            .css(t)
        ),
        l = $(s).width(),
        o = 0,
      ...
      switch (
        ($(s)
          .find("li")
          .each(function () {
            $(this).hasClass(app.unlimitedTabs.buttonNext.class) ||
              $(this).hasClass(app.unlimitedTabs.buttonPrev.class) ||
              (o += $(this).width());
          }),
        e)
      ) {
          ...
          (n = o + p - l) <= l
            ...
            0 !== i &&
              ("rtl" != $("body").css("direction")
                ? $(s)
                    .find("." + app.bootstrap.nav.tabs.class)
                    .animate({ marginLeft: "-" + i + "px" }, 150, function () {
                      $(s).addClass(app.unlimitedTabs.overflowLeft.class);
                    })
                : $(s)
                    .find("." + app.bootstrap.nav.tabs.class)
                    .animate({ marginRight: "-" + i + "px" }, 150, function () {
                      $(s).addClass(app.unlimitedTabs.overflowLeft.class);
                    }));
          break;
        case "prev":
          var n;
          (n = -p) <= l
            ? ($(s).removeClass(app.unlimitedTabs.overflowLeft.class), (i = 0))
            : (i = n - l + 80),
            "rtl" != $("body").css("direction")
              ? $(s)
                  .find("." + app.bootstrap.nav.tabs.class)
    ...
    function e() {
      $("." + app.unlimitedTabs.class).each(function () {
        !(function (a, e) {
          ...
          $(a)
            .find(" > ." + app.bootstrap.nav.tabs.itemClass)
            .first() &&
            (s = $(a)
              .find(
                "." +
          ...
          if (
            ...
            i != l && (n += 40),
              "rtl" == $("body").css("direction")
                ? $(a)
                    .find("." + app.bootstrap.nav.tabs.class)
                    .animate({ marginRight: "-" + n + "px" }, o)
                : $(a)
                    .find("." + app.bootstrap.nav.tabs.class)
                    .animate({ marginLeft: "-" + n + "px" }, o);
          }
          l != i && i >= p
            ? $(a).addClass(app.unlimitedTabs.overflowRight.class)
            : $(a).removeClass(app.unlimitedTabs.overflowRight.class),
            l >= p && i >= p
              ? $(a).addClass(app.unlimitedTabs.overflowLeft.class)
              : $(a).removeClass(app.unlimitedTabs.overflowLeft.class);
        })(this, 0);
      });
    }
    $("[" + app.unlimitedTabs.buttonNext.toggleAttr + "]").click(function (e) {
      ...
      $("[" + app.unlimitedTabs.buttonPrev.toggleAttr + "]").click(function (
        e
      ) {
  ...
  handleUnlimitedTopMenuRender = function () {
    ...
    function a(a, e) {
      ...
      switch (
        ($(s)
          .find("." + app.topMenu.menu.itemClass)
          .each(function () {
            $(this).hasClass(app.topMenu.control.class) ||
              (o += $(this).width());
          }),
        e)
      ) {
        ...
        case "prev":
          ...
          (n = -p) <= l
            ...
            : (i = n - l + 88),
            "rtl" != $("body").css("direction")
              ? $(s).animate({ marginLeft: "-" + i + "px" }, 150, function () {
                  $(s)
                    .find(
                      "." +
                        app.topMenu.control.class +
              ...
              : $(s).animate({ marginRight: "-" + i + "px" }, 150, function () {
                  $(s)
                    .find(
                      "." +
                        app.topMenu.control.class +
    ...
    function e() {
      ...
      if (
        ...
        var n = o - l + 128;
        "rtl" != $("body").css("direction")
          ? $(a).animate({ marginLeft: "-" + n + "px" }, 0)
          : $(a).animate({ marginRight: "-" + n + "px" }, 0);
      }
      o != i && i >= l
        ? $(a)
            .find(
            ...
            .addClass(app.topMenu.control.showClass)
        : $(a)
            .find(
              "." +
                app.topMenu.control.class +
            ...
            .removeClass(app.topMenu.control.showClass),
        o >= l && i >= l
          ? $(a)
              .find(
                "." +
    ...
    $("[" + app.topMenu.control.buttonNext.toggleAttr + "]").click(function (
      e
    ) {
      e.preventDefault(), a(this, "next");
    }),
      $("[" + app.topMenu.control.buttonPrev.toggleAttr + "]").click(function (
        e
      ) {
        e.preventDefault(), a(this, "prev");
      }),
  ...
  handleTopMenuSubMenu = function () {
    ...
    $(document).on(
      ...
      "." +
        ...
        " > ." +
        app.topMenu.menu.linkClass,
      function () {
        var a = $(this)
            .closest("." + app.topMenu.menu.itemClass)
            .find("." + app.topMenu.menu.submenu.class)
            .first(),
          e = $(this)
            .closest("." + app.topMenu.menu.itemClass)
            .find("." + app.topMenu.menu.submenu.class)
        ...
        $(e)
          ...
          .slideUp(250, function () {
            $(this)
              .closest("." + app.topMenu.menu.itemClass)
              .removeClass(app.topMenu.menu.expandClass);
          }),
          $(a).slideToggle(250, function () {
            var a = $(this).closest("." + app.topMenu.menu.itemClass);
            $(a).hasClass(app.topMenu.menu.expandClass)
              ? $(a).removeClass(app.topMenu.menu.expandClass)
              : $(a).addClass(app.topMenu.menu.expandClass);
          });
      }
    );
  },
      ...
      function () {
        if ($(window).width() <= 767) {
          var a = $(this)
              ...
              .first(),
            e = $(this)
              .closest("." + app.topMenu.menu.class)
              .find(
                "." +
                  app.topMenu.menu.hasSubClass +
                  " ." +
  ...
  handleToggleNavProfile = function () {
    var a = $("." + app.sidebar.class).attr(
      app.sidebar.menu.disableAnimationAttr
    )
      ? 0
      : app.sidebar.menu.animationTime;
    $(document).on(
      "click",
      "[" + app.sidebar.profile.toggleAttr + "]",
      function (e) {
        e.preventDefault();
        var s = $(this).closest("." + app.sidebar.profile.class),
          t = $(this).attr(app.sidebar.profile.targetAttr);
        $(t).is(":visible")
          ? ($(s).removeClass(app.sidebar.menu.activeClass),
            $(t).removeClass(app.sidebar.menu.closingClass))
          : ($(s).addClass(app.sidebar.menu.activeClass),
            $(t).addClass(app.sidebar.menu.expandingClass)),
          $(t).slideToggle(a, function () {
            $(t).is(":visible")
              ? ($(t).addClass(app.sidebar.menu.expandClass),
                $(t).removeClass(app.sidebar.menu.closedClass))
              : ($(t).addClass(app.sidebar.menu.closedClass),
                $(t).removeClass(app.sidebar.menu.expandClass)),
              $(t).removeClass(
                app.sidebar.menu.expandingClass +
                  " " +
                  app.sidebar.menu.closingClass
    ...
    $(document).on(
      ...
      function (a) {
        var e = $(this).next("." + app.sidebar.menu.submenu.class),
          ...
          p = !1;
        $(e).is(":visible")
          ? ($(s).addClass("closing"), (t = !0))
          : ($(s).addClass("expanding"), (p = !0)),
          $(e).slideToggle({
            ...
            progress: function () {
              var a = $(app.sidebar.floatSubmenu.id),
                ...
                o = $(a).attr("data-menu-offset-top"),
                i = s.top - $(window).scrollTop(),
                n = $(window).height();
              if (
                (t &&
                  i > l &&
            ...
            complete: function () {
              $(e).is(":visible")
                ? ($(s).addClass("expand"), $(s).removeClass("closed"))
                : ($(s).addClass("closed"), $(s).removeClass("expand")),
                $(s).removeClass("closing expanding");
            },
          });
      }
    ),
      $(document).on(
        {
          mouseenter: function () {
            if ($(app.id).hasClass(app.sidebar.minify.toggledClass)) {
              ...
              var a = $(this)
                .closest("." + app.sidebar.menu.itemClass)
                .find("." + app.sidebar.menu.submenu.class)
                .first();
              if (
                app.sidebar.floatSubmenu.dom == this &&
                0 !== $(app.sidebar.floatSubmenu.id).length
              )
                return;
              app.sidebar.floatSubmenu.dom = this;
              var e = $(a).html();
              if (e) {
                var s = $(app.sidebar.id).offset(),
                  ...
                  p =
                    $(app.id).hasClass(app.sidebarEnd.class) ||
                    "rtl" == $("body").css("direction")
                      ? $(window).width() - s.left
                      : s.left + t,
                ...
                if (0 === $(app.sidebar.floatSubmenu.id).length) {
                  var d = "";
                  l > r && (d = app.sidebar.floatSubmenu.overflow.class),
                    (e =
                      '<div class="' +
                      ...
                      o +
                      '" onmouseover="handleMouseoverFloatSubMenu(this)" onmouseout="handleMouseoutFloatSubMenu(this)">\t<div class="' +
                  ...
                  l > r
                    ? $(
                        app.sidebar.floatSubmenu.id +
                          " ." +
                          app.sidebar.floatSubmenu.class
                      ).addClass(app.sidebar.floatSubmenu.overflow.class)
                    : $(
                        app.sidebar.floatSubmenu.id +
                          app.sidebar.floatSubmenu.class
                      ).removeClass(app.sidebar.floatSubmenu.overflow.class),
                    $(app.sidebar.floatSubmenu.id).attr("data-offset-top", o),
                    $(app.sidebar.floatSubmenu.id).attr(
                      "data-menu-offset-top",
                      o
                    ),
                    $(
                ...
                if (r - o > (l = $(app.sidebar.floatSubmenu.id).height()))
                  $(app.sidebar.floatSubmenu.id).css({
                    top: o,
                    left: i,
                    bottom: "auto",
          ...
          mouseleave: function () {
            $(app.id).hasClass(app.sidebar.minify.toggledClass) &&
              (app.sidebar.floatSubmenu.timeout = setTimeout(function () {
                $(app.sidebar.floatSubmenu.line.id).remove(),
                  (app.sidebar.floatSubmenu.dom = "");
              }, 250));
  ...
  handleAjaxMode = function (a) {
    ...
    function t(a) {
      a
        ...
        : 0 === $(app.ajax.loader.id).length &&
          ($("body").addClass(app.ajax.loader.class), $(content.id).append());
    }
    function p(s, p, l) {
      Pace.restart(),
        t(!1),
        (function () {
          ...
          $(app.id).hasClass(app.sidebar.mobile.toggledClass) &&
        ...
        (function (a) {
          ...
          0 !== $(e).length &&
            ($(app.sidebar.id + " ." + app.sidebar.menu.itemClass).removeClass(
              app.sidebar.menu.activeClass
            ),
            $(e)
              .closest("." + app.sidebar.menu.itemClass)
              .addClass(app.sidebar.menu.activeClass),
            $(e)
              .parents("." + app.sidebar.menu.itemClass)
              .addClass(app.sidebar.menu.activeClass));
        })(s),
      ...
      var o = app.content.id,
        i = s.replace("#", ""),
        n = a.ajaxType ? a.ajaxType : "GET",
        r = a.ajaxDataType ? a.ajaxDataType : "html";
      p &&
        ((r = $(p).attr("data-type") ? $(p).attr("data-type") : r),
        (targetDataDataType = $(p).attr("data-data-type")
          ? $(p).attr("data-data-type")
          : r)),
        $.ajax({
          url: i,
          type: n,
    ...
    "" === (s = window.location.hash ? window.location.hash : s)
      ? $(app.content.id).html(e)
      : p(s, "", !0),
      $(window).on("hashchange", function () {
        window.location.hash ? p(window.location.hash, "", !0) : p(s, "", !0);
      }),
  ...
  handleSetPageOption = function (a) {
    a.appContentFullHeight && $(app.id).addClass(app.content.fullHeight.class),
      a.appSidebarLight && $(app.id).addClass(app.layout.sidebarLight.class),
      a.appSidebarEnd && $(app.id).addClass(app.layout.sidebarEnd.class),
      a.appSidebarWide && $(app.id).addClass(app.layout.sidebarWide.class),
      a.appSidebarMinified &&
        $(app.id).addClass(app.layout.sidebarMinified.class),
      a.appSidebarTwo &&
        ($(
          app.header.id + " [" + app.sidebarEnd.mobile.toggleAttr + "]"
        ).removeClass(app.helper.display.none),
        $(app.header.id + " ." + app.header.brand.class).removeClass(
          app.helper.margin.left[0]
        ),
        $(app.id).addClass(app.layout.sidebarTwo.class),
        $(app.id).addClass(app.sidebarEnd.toggledClass)),
      a.appSidebarTransparent &&
        $(app.sidebar.id).addClass(app.sidebar.transparent.class),
      a.appSidebarSearch &&
        $(app.sidebar.id + " ." + app.sidebar.search.class).removeClass(
          app.sidebar.search.hideClass
        ),
      a.appTopMenu &&
        ($(
          app.header.id + " [" + app.topMenu.mobile.toggleAttr + "]"
        ).removeClass(app.helper.display.none),
      ...
      a.appWithoutSidebar &&
        ...
        $(app.header.id + " [" + app.sidebar.mobile.toggleAttr + "]").addClass(
          app.helper.display.none
        ),
        $(
          app.sidebar.id +
            ", ." +
            app.sidebar.bg.class +
            ", ." +
            app.sidebar.mobile.backdrop.class
        ).css("display", "none")),
      a.appHeaderInverse && $(app.header.id).addClass(app.header.inverse.class),
      a.pageContentFullWidth &&
        $(app.content.id).addClass(app.content.fullWidth.class),
      a.appClass && $(app.id).addClass(a.appClass),
      a.appContentClass && $(app.content.id).addClass(a.appContentClass),
      a.bodyClass && $("body").addClass(a.bodyClass),
      a.appBoxedLayout && $("body").addClass(app.layout.boxedLayout.class),
      a.clearOptionOnLeave && (app.ajax.clearOption = a);
  },
  handleClearPageOption = function (a) {
    a.appContentFullHeight &&
      $(app.id).removeClass(app.content.fullHeight.class),
      a.appSidebarLight && $(app.id).removeClass(app.layout.sidebarLight.class),
      a.appSidebarEnd && $(app.id).removeClass(app.layout.sidebarEnd.class),
      a.appSidebarWide && $(app.id).removeClass(app.layout.sidebarWide.class),
      a.appSidebarMinified &&
        $(app.id).removeClass(app.layout.sidebarMinified.class),
      a.appSidebarTwo &&
        ($(
          app.header.id + " [" + app.sidebarEnd.mobile.toggleAttr + "]"
        ).addClass(app.helper.display.none),
        $(app.header.id + " ." + app.header.brand.class).addClass(
          app.helper.margin.left[0]
        ),
      ...
      a.appSidebarSearch &&
        $(app.sidebar.id + " ." + app.sidebar.search.class).addClass(
          app.sidebar.search.hideClass
        ),
      a.appTopMenu &&
        ($(app.header.id + " [" + app.topMenu.mobile.toggleAttr + "]").addClass(
          app.helper.display.none
        ),
      ...
      a.appWithoutSidebar &&
        ...
        $(
          app.header.id + " [" + app.sidebar.mobile.toggleAttr + "]"
        ).removeClass(app.helper.display.none),
        $(
          app.sidebar.id +
            ", ." +
      ...
      a.appContentFullWidth &&
        $(app.content.id).removeClass(app.content.fullWidth.class),
      a.appContentClass && $(app.content.id).removeClass(a.appContentClass),
      a.appClass && $(app.id).removeClass(a.appClass),
      a.bodyClass && $("body").removeClass(a.bodyClass),
      a.appBoxedLayout && $("body").removeClass(app.layout.boxedLayout.class);
  },
  handleToggleNavbarSearch = function () {
    $("[" + app.header.floatingForm.toggleAttr + "]").click(function (a) {
      a.preventDefault(),
        $("." + app.header.class).addClass(
          app.header.floatingForm.toggledClass
        );
    }),
    ...
    $("[" + app.animation.attr + "]").each(function () {
      ...
      switch (a) {
        ...
        case "height":
          ...
          break;
        case "number":
          for (var s = this, t = countDecimals(e), p = 1, l = t; l > 0; )
            (p *= 10), l--;
        ...
        (a = a.toLowerCase())
          ? ($(
              "." +
                ...
                " > ." +
                app.sidebar.menu.itemClass
            ).addClass(app.sidebar.search.hideClass),
            $(
              "." +
                app.sidebar.class +
                ":not(." +
            ...
            ).removeClass(app.sidebar.search.foundClass),
            $(
              "." +
                app.sidebar.class +
                ":not(." +
            ...
            $(
              ...
              var e = $(this).text();
              (e = e.toLowerCase()).search(a) > -1 &&
                ($(this)
                  .closest("." + app.sidebar.menu.itemClass)
                  .removeClass(app.sidebar.search.hideClass),
                $(this)
                  .closest("." + app.sidebar.menu.itemClass)
                  .addClass(app.sidebar.search.foundClass),
                0 !=
                  $(this).closest(
                    "." +
                      app.sidebar.menu.itemClass +
                  ...
                  $(this)
                    ...
                    .removeClass(app.sidebar.search.hideClass),
                0 !=
                  $(this).closest("." + app.sidebar.menu.submenu.class)
                    .length &&
                  ($(this)
                    .closest("." + app.sidebar.menu.submenu.class)
                    .css("display", "block"),
                  $(this)
                    .closest("." + app.sidebar.menu.hasSubClass)
                    .removeClass(app.sidebar.search.hideClass)
                    .addClass(app.sidebar.menu.expandClass),
                  $(this)
                    .closest("." + app.sidebar.menu.submenu.class)
                    .find(
                      "." +
  ...
  handleToggleClass = function () {
    $(document).on(
      ...
      function (a) {
        a.preventDefault();
        var e = $(this).attr(app.toggleClass.targetAttr)
            ? $(this).attr(app.toggleClass.targetAttr)
            : "",
  ...
  handleDismissClass = function () {
    $(document).on(
      "click",
      "[" + app.dismissClass.toggleAttr + "]",
      function (a) {
        a.preventDefault();
        var e = $(this).attr(app.dismissClass.targetAttr)
            ? $(this).attr(app.dismissClass.targetAttr)
            : "",
  ...
  stringToColor = function (a) {
    for (var e = 0, s = 0; s < a.length; s++)
      e = a.charCodeAt(s) + ((e << 5) - e);
    var t = "#";
    for (s = 0; s < 3; s++) {
      t += ("00" + ((e >> (8 * s)) & 255).toString(16)).substr(-2);
    }
    return t;
  },
  hexToRgba = function (a, e = 1, s = !1) {
    var t;
    if (/^#([A-Fa-f0-9]{3}){1,2}$/.test(a))
      return (
        3 == (t = a.substring(1).split("")).length &&
          (t = [t[0], t[0], t[1], t[1], t[2], t[2]]),
        "rgba(" +
          [((t = "0x" + t.join("")) >> 16) & 255, (t >> 8) & 255, 255 & t].join(
            ","
          ) +
          "," +
          e +
    ...
    if (!s) return (a = stringToColor(a)), hexToRgba(a, e, !0);
    throw new Error("Bad Hex");
  },
  getCssVariable = function (a) {
    return window.getComputedStyle(document.body).getPropertyValue(a).trim();
  },
  App = (function () {
    "use strict";
    var a;
    return {
      ...
      initSidebar: function () {
        handleSidebarMenu(),
          ...
          handleSidebarSearch(),
          (!a || (a && !a.disableSidebarScrollMemory)) &&
      ...
      initComponent: function () {
        (!a || (a && !a.disableDraggablePanel)) && handlePanelDraggable(),
          handleScrollbar(),
          ...
          handleToggleClass(),
          handleDismissClass(),
          $(window).width() > 767 && handelTooltipPopoverActivation();
      },
      ...
      initVariable: function () {
        (app.color.theme = getCssVariable("--app-theme")),
          ...
          (app.color.componentColorRgb = getCssVariable(
            "--app-component-color-rgb"
          )),
