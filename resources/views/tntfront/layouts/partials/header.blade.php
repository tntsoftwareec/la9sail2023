    ...
    <div class="navbar-header">
        <a href="index.html" class="navbar-brand">
            ...
            <!-- <i class="ion-ios-cloud"></i> -->
               <img src="{{ asset('/tntfront/assets/img/logo/ca.png') }}" height="50" width="50" alt="">
            </div>
            <b class="me-1">Tnt</b> Softwre
        </a>
    ...
    <div class="navbar-nav">
        ...
        <div class="navbar-item dropdown">
            ...
            <div class="dropdown-menu media-list dropdown-menu-end">
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="{{ asset('tntfront/assets/img/user/user-1.jpg') }}" class="media-object" alt="" />
                ...
                <a href="javascript:;" class="dropdown-item media">
                    <div class="media-left">
                        <img src="{{ asset('tntfront/assets/img/user/user-2.jpg') }}" class="media-object" alt="" />
                        <i class="fab fa-facebook-messenger text-blue media-object-icon"></i>
                    </div>
                    <div class="media-body">
        ...
        <div class="navbar-item navbar-user dropdown">
            <a href="#" class="navbar-link dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown">
                <img src="{{asset('tntfront/assets/img/user/user-13.jpg') }}" alt="" />
                <span>
        ...
        {{-- <div class="navbar-item">
            <a href="#" class="navbar-link ">
                <img src="{{ asset('tntfront/img/iconos/32px/sidebar32.png') }}" alt="">
            </a>
        </div> --}}
        <div class="navbar-item">
            <a href="#" class="navbar-link ">
                <i class="ion ion-ios-expand text-info"></i>
            </a>
        </div>
        <div class="navbar-item">
